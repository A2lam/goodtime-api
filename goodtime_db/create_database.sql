...
-- -----------------------------------------------------
-- Table `goodtime`.`user_good_times`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `goodtime`.`user_good_times` ;

CREATE TABLE IF NOT EXISTS `goodtime`.`user_good_times` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `users_id` INT NOT NULL,
  `goodtimes_id` INT NOT NULL,
  `status` VARCHAR(3) NULL,
  `is_sam` TINYINT NULL DEFAULT 0,
  `created_by` INT NOT NULL,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_by` INT NULL,
  `updated_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ...
  CONSTRAINT `fk_user_goodtime_goodtimes1`
    ...
    REFERENCES `goodtime`.`good_times` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
